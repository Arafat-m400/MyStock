                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" href="/MyStock/admin/branches.php"><i class="fas fa-building me-2"></i>Manage Branches</a></li>
                            <li><a class="dropdown-item" href="/MyStock/admin/users.php"><i class="fas fa-users-cog me-2"></i>Manage Users</a></li>
